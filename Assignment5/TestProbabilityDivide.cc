...
int main() {
  ...
  if ( firstCheck == firstCheckCorrect )
    cout << firstCheck.ToString() << " passed first Divide test" << endl;
  else
    cout << "failed first Divide test" << endl;

  secondCheck.Divide(-2);
  if ( secondCheck == secondCheckCorrect )
    cout << secondCheck.ToString() << " passed second Divide test" << endl;
  else
    cout << "failed second Divide test" << endl;

  thirdCheck.Divide(0);
  if ( thirdCheck == thirdCheckCorrect )
    cout << thirdCheck.ToString() << " passed third Divide test" << endl;
  else
