...
int main() {
  ...
  if ( half.ToString() == "1/2" )
    ...
    cout << half.ToString() << " failed first ToString test" << endl;

  if ( twothirds.ToString() == "2/3" )
    cout << "passed second ToString test" << endl;
  else
    cout << twothirds.ToString() << " failed second ToString test" << endl;

  if ( negativethird.ToString() == "-1/3" )
    cout << "passed third ToString test" << endl;
  else
    cout << negativethird.ToString() << " failed third ToString test" << endl;
